...
namespace OtoServis.WebUI.Areas.Admin.Controllers
{
    ...
    public class CarsController : Controller
    {
        ...
        public CarsController(IService<Marka> serviceMarka, ICarService service)
        {
        ...
        {
            ViewBag.MarkaId = new SelectList(await _serviceMarka.GetAllAsync(), "Id", "Name");
        ...
        public async Task<ActionResult> CreateAsync(Arac arac, IFormFile? Resim1, IFormFile? Resim2, IFormFile? Resim3)
        {
            if (ModelState.IsValid)
            {
                try
               {
                    ...
                    await _service.UpdateAsync(arac);
